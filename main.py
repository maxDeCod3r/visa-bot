...
class VisaBot:
    ...
    def main(self, driver):
        ...
        new_application_button = (221, 223)
...
class Main:
    ...
    def run_loop(self):
        ...
        while self.do_run:
            ...
            if time.time() - self.last_upd_time > (3*60*60):  # if over 6 hours has passed since last results notification
                info("3 Hour cycle complete, sending results")
